cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89  -Wno-error=deprecated-declarations -Wno-deprecated-declarations     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
